...
class DebugCodeTask:
    def __init__(self):
        ...
        self.task_name = "تصحيح الكود"
        self.duration = "15-20 دقيقة"
...
Based on that explanation, explain the Debugging concept in more detail.
Use real software examples only, no food analogies.
All text must be in Arabic except programming terms like Bug, Error, return, def, etc.

Respond ONLY in valid JSON, no extra text:
{{
  "concept_title": "Debugging",
  "concept_explanation": "شرح بسيط بالعربي لما هو الـ Debugging، 3-4 جمل، بناءً على ما قرأه الطالب",
  "real_world_example": "مثال حقيقي بالعربي لـ Bug في برنامج وكيف تم إيجاده",
...
"""
    ...
    def generateTask(self, concept: dict, major_explanation: str) -> dict:
        prompt = f"""
You are creating a beginner debugging task for a Software Engineering student.
...
- Give them a very simple Python code snippet with ONE obvious bug

Respond ONLY in valid JSON, no extra text:
{{
  "task_title": "تصحيح الكود",

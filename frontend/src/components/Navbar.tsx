  ...
  return (
    ...
    <nav className="fixed top-0 left-0 right-0 z-100 px-12 h-16 flex items-center justify-between bg-bg-dark backdrop-blur-md border-b border-white/8">
      ...
      <div className="flex items-center gap-3">
        <Link
          to="/auth?mode=login"
          className="text-[13px] font-medium text-text-muted no-underline px-4.5 py-1.75 rounded-md border border-white/15 transition-all duration-200 hover:text-white hover:border-white/35"
        >
          تسجيل الدخول
        </Link>
